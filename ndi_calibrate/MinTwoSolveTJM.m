...
clear
clc
file1='/home/edward/kuka_catkin/src/ndi_calibrate/NDI_from_windows/Rx.txt';%加载txt数据
Tx=load(file1);
file2='/home/edward/kuka_catkin/src/ndi_calibrate/NDI_from_windows/Ry.txt';
Ty=load(file2);
file3='/home/edward/kuka_catkin/src/ndi_calibrate/NDI_from_windows/Rz.txt';
Tz=load(file3);
file4='/home/edward/kuka_catkin/src/ndi_calibrate/NDI_from_windows/Dx.txt';
Rx=load(file4);
file5='/home/edward/kuka_catkin/src/ndi_calibrate/NDI_from_windows/Dy.txt';
Ry=load(file5);
file6='/home/edward/kuka_catkin/src/ndi_calibrate/NDI_from_windows/Dz.txt';
Rz=load(file6);
file7='/home/edward/kuka_catkin/src/ndi_calibrate/NDI_from_windows/TCP.txt';
TCP=load(file7);
% TON=load('/home/edward/kuka_catkin/src/ndi_calibrate/NDI_from_windows/TON.txt');
[m,n]=size(Rx);
%NDI=textread('/home/edward/kuka_catkin/src/ndi_calibrate/NDI_from_windows/NDI.txt','',1,'delimiter',',');
NDIS=load('/home/edward/kuka_catkin/src/ndi_calibrate/NDI_from_windows/NDIS.txt');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fid=fopen('/home/edward/kuka_catkin/src/ndi_calibrate/NDI_from_windows/TJM.txt','wt');%改为你自己文件的位置
[m,n]=size(TJM);
for i=1:m
   for j=1:n
     if j==n
...
fid=fopen('/home/edward/kuka_catkin/src/ndi_calibrate/NDI_from_windows/TOB.txt','wt');%改为你自己文件的位置
[m,n]=size(TOB);
for i=1:m
   for j=1:n
     if j==n
...
% fid=fopen('/home/edward/kuka_catkin/src/ndi_calibrate/NDI_from_windows/TBN.txt','wt');%改为你自己文件的位置
% [m,n]=size(TBN);
% for i=1:m
%    for j=1:n
%      if j==n
