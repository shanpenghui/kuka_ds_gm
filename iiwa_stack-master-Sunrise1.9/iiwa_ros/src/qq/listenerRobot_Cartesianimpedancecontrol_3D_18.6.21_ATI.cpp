...
ros::Subscriber sub5=n.subscribe("/ft_sensor/data", 1000, chatterCallback4);         				 //修改为用ATI的力
...
//  ros::Publisher chatter_pub2 = n.advertise<geometry_msgs::PoseStamped>("/iiwa/command/CartesianPose", 1000);
  ...
  ros::Publisher chatter_pub3 = n.advertise<iiwa_msgs::JointPosition>("/iiwa/command/JointPosition", 1000);			//修改为用ATI的力
